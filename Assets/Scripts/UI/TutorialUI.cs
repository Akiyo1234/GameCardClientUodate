...
public class TutorialUI : MonoBehaviour
{
    ...
    public SlideData[] slides = new SlideData[]
    {
        ...
        new SlideData
        {
            title       = "[ การจองการ์ด & เหรียญพิเศษ/เหรียญดำ ]",
            body        = "คุณสามารถจองการ์ดได้ง่ายๆ โดยการ <b>กดค้างที่การ์ด</b> ที่ต้องการ\n\n" +
                          "เมื่อจองการ์ดสำเร็จ คุณจะได้รับ <b>เหรียญพิเศษ/เหรียญดำ</b> จำนวน 1 เหรียญ\n\n" +
                          "เหรียญพิเศษ/เหรียญดำมีความพิเศษมาก เพราะสามารถนำไปใช้ <b>แทนเหรียญสีใดก็ได้</b> 1 เหรียญในการซื้อการ์ด!",
            icon        = "COIN",
            illustrationSprite = null,
        ...
        new SlideData
        {
            ...
            body        = "เกมนี้ไม่ได้วัดแค่ดวง! <b>ทุกๆ 5 รอบ</b> จะมีช่วงเวลาตอบคำถาม\n\n" +
                          "ผลการตอบคำถามมีผลอย่างมาก เพราะ<b>ผู้ที่ตอบถูกและเร็วสุด จะได้เริ่มเล่นก่อน</b>ในรอบถัดไป\n\n" +
