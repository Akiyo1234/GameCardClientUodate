...
grant execute on function public.claim_matchmaking_room(text, integer, text, text, text, integer)
    to anon, authenticated, service_role;

grant execute on function public.cancel_matchmaking_search(text, text)
    to anon, authenticated, service_role;
